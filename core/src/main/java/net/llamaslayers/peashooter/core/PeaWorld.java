...
import net.llamaslayers.peashooter.core.entities.Entity;
import net.llamaslayers.peashooter.core.entities.PhysicsEntity;
...
public class PeaWorld implements ContactListener {
	...
	public PeaWorld( GroupLayer scaledLayer ) {
		...
		groundShape
				.setAsEdge( new Vec2( 0, height ), new Vec2( width, height ) );
		...
		wallRightShape
				.setAsEdge( new Vec2( width, 0 ), new Vec2( width, height ) );
